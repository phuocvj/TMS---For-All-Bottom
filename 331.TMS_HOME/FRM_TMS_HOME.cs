    ...
    public partial class FRM_TMS_HOME : Form
    {
        ...
        public DataTable getTMSHomeRATIO(string ARG_LINE, string ARG_MLINE, string ARG_YMD, string ARG_TRIP, string ARG_LOC)
        {
            try
            {
                ...
                string process_name = "MES.PKG_TMS_HOME.TMS_HOME_RATIO_V2";
        ...
        private void initUserControl()
        {
            try
            {
                ...
                string[] tit = new string[] { "F1", "PLANT N", "VJ3","VJ3", "BOTTOM", "OUTSOLE", "IP", "PHYLON", "PU", "DMP" };
                //string[] tit = new string[] { "F1", "PLANT N", "UPPER", "BOTTOM", "OUTSOLE", "IP", "PHYLON", "PU", "DMP" };
                //string[] code = new string[] { "F1", "99", "UP", "BT", "OS", "IP", "PH", "PU", "DMP" };
                string[] code = new string[] { "F1", "99", "VJ3","VJ3S", "BT", "OS", "IP", "PH", "PU", "DMP" };
                string[] desc = new string[] { "VJ2->F1", "VJ2->Plant N", "VJ3->VJ1 (Upper)","VJ3->VJ1 (Screen)", "VJ1->VJ2", "Outsole->VJ1,VJ2", "IP->VJ1,VJ2", "Phylon->VJ1,VJ2", "PU->VJ1,VJ2", "DMP->VJ1,VJ2" };
